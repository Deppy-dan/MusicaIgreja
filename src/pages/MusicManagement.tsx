              ...
              <TableBody>
                {songs.data?.map((song) => (
                  <TableRow key={song.id}>
                    <TableCell>
                      <Checkbox 
                        checked={selectedSongs.includes(Number(song.id))}
                        // Certifique-se de converter o id em número durante a chamada:
                        onCheckedChange={() => toggleSongSelection(Number(song.id))}
                      />
                    </TableCell>
                    <TableCell className="font-medium">{song.title}</TableCell>
                    <TableCell>{song.key}</TableCell>
